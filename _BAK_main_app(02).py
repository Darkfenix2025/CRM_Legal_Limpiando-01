...
# Estos archivos deben existir en la misma carpeta
...
class CRMLegalApp:
    def __init__(self, root):
        ...
        self.open_case_windows = {} # Para rastrear ventanas de detalles abiertas
        self.db_crm = db
    ...
    def open_case_detail_window(self, event=None):
        """Abre o enfoca la ventana Toplevel para el caso seleccionado."""
    ...
    def on_case_window_close(self, case_id):
        """Callback para cuando se cierra una ventana de detalles."""
        if case_id in self.open_case_windows:
    ...
    def create_widgets(self):
        ...
        # --- Columna 1: Clientes (Sin cambios) ---
        ...
        # --- Columna 2: Logo y Calendario (NUEVA DISPOSICIÓN) ---
        ...
        try:
            ...
            ttk.Label(logo_frame, text="Legal-IT-Ø").pack(pady=20)
        ...
        # --- Columna 3: Casos y Audiencias (NUEVA DISPOSICIÓN) ---
